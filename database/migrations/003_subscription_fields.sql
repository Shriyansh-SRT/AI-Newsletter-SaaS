...
-- Note: RLS policies are already enabled for user_preferences table
-- The existing policies will automatically apply to the new subscription columns
-- since they use auth.uid() = user_id which covers all columns in the table
